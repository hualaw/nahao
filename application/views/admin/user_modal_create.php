<!-- Modal -->
<div class="modal fade" id="user_create_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btn_user_submit" data-action="/user/create"> &nbsp;创建 &nbsp;</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
