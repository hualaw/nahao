...
class TiziOauth {
	...
	/*授权地址*/
	Const AUTORIZE_URL = "http://api.tizi.com/oauth/show";
	/*获取accessToken Api*/
	Const ACCESSTOKEN_URL = "http://api.tizi.com/oauth/access_token";
	/*获取用户资料  Api*/
	Const USER_INFO_URL = "http://api.tizi.com/oauth/user/get_user_info";
	/*获取openid Api*/
	Const GET_OPENID_URL = "http://api.tizi.com/oauth/me";
