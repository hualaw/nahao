...
class Anti_Spam
{
    ...
    {
        static $client = null;
        $x_forwarded_for_addr = 'null';
        if (!$client) {
            if (isset($_SERVER['HTTP_X_FORWARDED_FOR'])) {
                $x_forwarded_for_addr = $_SERVER['HTTP_X_FORWARDED_FOR'];
...
//            }
	    ...
	    $message = "$client\t{$x_forwarded_for_addr}\t{$_SERVER['REMOTE_ADDR']}";
    ...
    private static function getConnection()
    {
        ...
        else
        {
            ...
            if($_nmc != 1) setcookie('_nmc',1,0,'/','.nahao.com');
            return false;
        }
        //return $connection;
    }
