...
define('NH_IMG_SIZE_COURSE_W8',130);//我的课程列表宽
define('NH_IMG_SIZE_COURSE_H8',82);//我的课程列表高
...
define('NH_IMG_SIZE_COURSE_W9',50);//我的课程列表宽
define('NH_IMG_SIZE_COURSE_H9',50);//我的课程列表高
