...
$config['production_round_time_config']['before_sell_end_time_max'] = 86400 * 30 * 4; //最长销售期
...
$config['material_version'][17] = '苏科版';
$config['material_version'][18] = '沪科版';
